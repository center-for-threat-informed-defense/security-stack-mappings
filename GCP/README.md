...
|[T1059 - Command and Scripting Interpreter](https://attack.mitre.org/techniques/T1059/)|Protect|Partial|Advanced Protection Program provides protection against harmful downloads. Google's "Safe Browsing" feature may flag Chrome downloads as potentially harmful, or even block downloads altogether. Users have the option to send suspicious files to Advanced Protection to be scanned to determine if its safe or dangerous. While Advanced Protection Program can help users identify and avoid downloading potentially harmful files, this capability is only available on Chrome.<br/>|
...
|[T1601 - Modify System Image](https://attack.mitre.org/techniques/T1601/)|Protect|Significant|Advanced Protection Program enables the use of a security key for multi-factor authentication. Using multi-factor authentication for user and privileged accounts can prevent adversaries from accessing and consequently modifying the operating system of embedded network devices.<br/>|
