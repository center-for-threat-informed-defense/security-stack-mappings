...
|[T1537 - Transfer Data to Cloud Account](https://attack.mitre.org/techniques/T1537/)|Protect|Significant|This control may mitigate against exfiltration attempts to external cloud accounts by limiting egress of data from accounts and services contained within the VPC network perimeter.|
